...
public class MainActivity extends Activity {
    ...
    // private final static String URL_SERVIDOR ="192.168.43.19"; // comprobar IP local que puede cambiar
    private final static String URL_SERVIDOR ="ramonjmc.pe.hu"; // hosting en hostinger
    // private final static String URL_SERVIDOR ="ramonjmc.edusite.me";
