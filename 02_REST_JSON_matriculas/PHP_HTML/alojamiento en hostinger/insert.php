<?php
	// alojamiento en hostinger => ramonjmc.pe.hu	
	...
	$database ="u123456_alum"; //Nombre de nuestra base de datos
	$username ="u123456_usu2";       //Nombre de usuario de nuestra base de datos 
